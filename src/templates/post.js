      ...
      <div className="sidebar col-divide-3 col-divide-md-12">
        <div className="sidebar__item">
          ...
          <div className="sidebar__cotent social--sidebar">
            <a href="#" target="_blank" className="social--icon social--facebook">
              <i className="fab fa-facebook-square"></i>
            </a>
            <a href="#" target="_blank" className="social--icon social--instagram">
              <i className="fab fa-instagram"></i>
            </a>
            <a href="#" target="_blank" className="social--icon social--behance">
              <i className="fab fa-behance-square"></i>
            </a>
            <a href="#" target="_blank" className="social--icon social--pinterest">
