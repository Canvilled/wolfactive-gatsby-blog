...
export default ({data,pageContext}) =>{
  ...
  const nextPage = `/seo/trang-${currentPage +1}`;
  const prevPage = currentPage - 1 === 1 ? '/' : `/seo/trang-${String(currentPage-1)}`;
           ...
           <div className="pagination">
              <div className="pagination__container">
                ...
                {((currentPage === 1 )&&(numberOfPages !== 1))&& (
                  <>
                  <div className="pagination__item">
                    <Link to="seo" rel="current" className="pagination__number active">
                      {currentPage }
                    </Link>
                  </div>
                  <div className="pagination__item">
